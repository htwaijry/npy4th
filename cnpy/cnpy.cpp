...
void cnpy::parse_npy_header(FILE* fp, size_t& word_size, char& arrayType, std::vector<size_t>& shape, bool& fortran_order) {  
    char buffer[256];
...
cnpy::NpyArray cnpy::npz_load(std::string fname, std::string varname) {
    ...
    fclose(fp);
    throw std::runtime_error("npz_load: Error! Variable name not found!\n");
...
cnpy::NpyArray cnpy::npy_load(std::string fname) {
    ...
    if(!fp) {
        throw std::runtime_error("npy_load: Error! Unable to open file!\n");
